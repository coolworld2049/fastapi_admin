...
async def read_users(
        ...
        request_params: RequestParams = Depends(params.parse_react_admin_params(User))
) -> Any:
    """
    Retrieve users.
    """
...
async def read_user_me(
    ...
    Get current user.
    """
    user = await crud.user.get_session()
...
async def update_user(
        *,
        ...
        current_user: User = Depends(authentication.get_current_active_superuser),
) -> Any:
    """
    Update a user.
    """
...
async def delete_user(
    ...
    Delete an task.
    """
    item = await crud.user.get_session()
    if not item:
